...
module.exports = {
  ...
  rules: {
    indent: [0], //缩进 // allow async-await
    "generator-star-spacing": "off", //函数前后空格 // allow debugger during development
    ...
    semi: ["error", "never"], //在语句末尾需要分号  忽略块中的最后一个分号 这里我有点不解 import Main from '@/views/Main.vue';会报错  但是现在这样确实是我要的效果
